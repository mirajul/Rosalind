...
from Textbook_03D import score, profile_most_probable_kmer
from Textbook_03E import profile_with_pseudocounts
...
if __name__ == '__main__':
	...
	with open('data/textbook/rosalind_3g.txt') as input_data:
	...
	print '\n'.join(best_motifs[1])
	with open('output/textbook/Textbook_03G.txt', 'w') as output_data:
		output_data.write('\n'.join(best_motifs[1]))
